...
public class StressStoreCsv implements IStressStore {
	...
	public StressStoreCsv(File cycleOutputFile, File globalOutputFile) {
		this.fileCycle = cycleOutputFile != null ? cycleOutputFile : new File(Task.STORE_PATH, "stress-cycle-results.csv");
		this.fileGlobal = globalOutputFile != null ? globalOutputFile : new File(Task.STORE_PATH, "stress-final-results.csv");
		open();
		writeHeaders();
	}
