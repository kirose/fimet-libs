...
public class StressStoreCsv implements IStressStore {
	...
	public StressStoreCsv(File cycleOutputFile, File globalOutputFile) {
		this.fileCycle = cycleOutputFile != null ? cycleOutputFile : new File(Paths.STORE_PATH, "stress-cycle-results.csv");
		this.fileGlobal = globalOutputFile != null ? globalOutputFile : new File(Paths.STORE_PATH, "stress-final-results.csv");
		open();
		writeHeaders();
	}
