...
import com.fimet.sqlite.entity.EUseCaseStore;
import com.j256.ormlite.dao.RawRowMapper;
import com.j256.ormlite.stmt.PreparedQuery;
import com.j256.ormlite.stmt.QueryBuilder;
import com.j256.ormlite.support.ConnectionSource;

public class UseCaseDAO extends AbstractDAO<EUseCaseStore,String> {
	private static UseCaseDAO instance;
	public static UseCaseDAO getInstance() {
		if (instance == null) {
			instance = new UseCaseDAO();
		}
		return instance;
	}
	public UseCaseDAO() {
	...
	public UseCaseDAO(ConnectionSource connection) {
		super(connection);
	}
