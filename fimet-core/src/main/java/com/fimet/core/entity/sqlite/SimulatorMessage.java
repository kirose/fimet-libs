...
public class SimulatorMessage implements Cloneable {
	...
	public SimulatorMessage(Integer idSimulator, String header, String mti, Character type, String excludeFields) {
		super();
		this.header = header;
	...
	public SimulatorMessage(Integer idSimulator, String mti, Character type, String excludeFields) {
