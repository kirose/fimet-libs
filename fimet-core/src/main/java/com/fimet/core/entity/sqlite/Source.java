...
import com.fimet.core.entity.sqlite.type.SourceTypeType;
...
public class Source {
	...
	public Source(Integer id, String className) {
		this(id, (Integer)null, className, null, null);
	}
	public Source(Integer idType, String className, String source, byte[] bytecode) {
		this(null, idType, className, source, bytecode);
	}
	public Source(Integer id, Integer idType, String className, String source, byte[] bytecode) {
		super();
		this.id = id;
		this.type = idType != null ? new SourceType(idType) : null;
		this.className = className;
		this.source = source;
		this.bytecode = bytecode;
	}
	public Source(Integer id, SourceType type, String className, String source, byte[] bytecode) {
		super();
		this.id = id;
		this.type = type;
		this.className = className;
