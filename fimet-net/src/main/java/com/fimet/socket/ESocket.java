...
public class ESocket implements IESocket {
	...
	public ESocket(String name, String address, Integer port, boolean server, IAdapter adapter) {
		this(name, address, port, server, adapter.getName());
	}
	public ESocket(String name, String address, Integer port, boolean server, String adapter) {
		super();
		this.name = name;
