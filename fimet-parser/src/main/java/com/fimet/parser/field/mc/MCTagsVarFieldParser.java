...
public class MCTagsVarFieldParser extends VarFieldParser {
	private static Logger logger = LoggerFactory.getLogger(MCTagsVarFieldParser.class);
	public MCTagsVarFieldParser(FieldGroup fieldGroup, IEFieldFormat fieldFormat) {
