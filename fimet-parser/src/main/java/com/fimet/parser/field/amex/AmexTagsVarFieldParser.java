package com.fimet.parser.field.amex;
...
public class AmexTagsVarFieldParser extends VarFieldParser {
	private static Logger logger = LoggerFactory.getLogger(AmexTagsVarFieldParser.class);
	public AmexTagsVarFieldParser(FieldGroup fieldGroup, IEFieldFormat fieldFormat) {
