...
public class TpvTags55VarFieldParser extends VarFieldParser {
	private static Logger logger = LoggerFactory.getLogger(TpvTags55VarFieldParser.class);
	public TpvTags55VarFieldParser(FieldGroup fieldGroup, IEFieldFormat fieldFormat) {
