...
public final class XmlUtils {
	...
	public static <T> T fromFile(File file, Class<T> clazz) {
		try {
			...
			FimetLogger.error(Manager.class,"Error parsing xml "+file,e);
			throw new FimetException("Error parsing xml "+file,e);
		}
	}
	...
	public static void writeXml(Object instance, File out) {
		try {
			...
			FimetLogger.error(Manager.class,"Error formating xml "+out,e);
			throw new FimetException("Error formating xml "+out,e);
		}
	}
	public static String toXml(Object instance) {
		try {
			...
			FimetLogger.error(Manager.class,"Error formating xml "+instance,e);
			throw new FimetException("Error formating xml "+instance,e);
		}
	}
