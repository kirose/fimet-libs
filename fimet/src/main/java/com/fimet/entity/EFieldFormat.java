...
public class EFieldFormat {
	...
	public EFieldFormat() {}
	public EFieldFormat(Integer idGroup, String idOrder, String idField, Integer idConverterValue, Integer idConverterLength, Integer idParserLength, String type, Integer length, Integer maxLength, String name, Class<?> classParser) {
		super();
