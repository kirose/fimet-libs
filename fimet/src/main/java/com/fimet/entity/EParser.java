...
public class EParser {
	...
	public EParser() {}
	public EParser(Integer idParser, String name, Integer idFieldGroup, String parserClass, Integer idConverter, Integer type, String keySequence) {
		super();
		this.idGroup = idFieldGroup;
		this.id = idParser;
		this.name = name;
