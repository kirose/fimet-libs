...
import com.fimet.entity.sqlite.type.ListSimulatorFieldType;
import com.fimet.entity.sqlite.type.ListStringType;
...
public class ESimulatorMessage implements Cloneable {
	public static char REQUEST = 'Q';
	public static char RESPONSE = 'S';
	...
	public ESimulatorMessage(Integer idSimulator, String header, String mti, Character type, String excludeFields) {
		super();
		this.header = header;
	...
	public ESimulatorMessage(Integer idSimulator, String mti, Character type, String excludeFields) {
		this(idSimulator, null, mti, type, excludeFields);
	}
	...
	public ESimulatorMessage addIncludeFieldCls(String key, Class<?> clazz) {
		includeFields.add(new SimulatorField(key, SimulatorField.CUSTOM, clazz.getName()));
		return this;
	}
	public ESimulatorMessage addIncludeFieldFix(String key, String value) {
