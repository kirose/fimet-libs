...
import com.fimet.json.adapter.MessageAdapter;
...
public class Message implements Serializable, Cloneable, IMessage {
	...
	public Message(String mti, String header, IParser parser) {
		this.mti = mti;
		this.header = header;
		this.parser = parser;
