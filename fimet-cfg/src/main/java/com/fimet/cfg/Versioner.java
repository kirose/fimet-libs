...
public class Versioner {
	...
	private static final File FILE_VERSION = new File("C:\\eclipse\\wsbuilderfimet\\com.fimet.core\\src\\com\\fimet\\core\\Version.java");
	...
	private static Version fromString(String s) {
		try {
			...
			e.printStackTrace();
			//FimetLogger.error("Invalid Version "+s);
