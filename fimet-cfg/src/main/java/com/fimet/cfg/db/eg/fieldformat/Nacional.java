...
public class Nacional {
	...
	public void insert() {
		...
		dao.insertOrUpdate(new FieldFormat(idGroup,"058","58",NONE.getId(),NONE.getId(),DEC.getId(),"(?s).+",3,999,"Datos de lealtad",VarFieldParser.class));
		...
		dao.insertOrUpdate(new FieldFormat(idGroup,"062","62",NONE.getId(),NONE.getId(),DEC.getId(),"(?s).*",3,999,"Postal Code",VarFieldParser.class));
