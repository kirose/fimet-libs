...
public class Jcb {
	FieldFormatDAO dao;
	int idGroup = FieldFormatGroup.JCB.getId();
	public Jcb(FieldFormatDAO dao) {
		this.dao = dao;
	}
	public void insert() {
		...
		dao.insertOrUpdate(new FieldFormat(idGroup,"010","10",NONE.getId(),null,null,"[0-9]+",10,null,"Conversion rate, cardholder billing",LTrimFixedFieldParser.class));
		...
		new FieldFormatBuilder(new FieldFormat(idGroup,"022","22",NONE.getId(),null,null,"[0-9]+",3,null,"Point of service entry mode",LTrimFixedFieldParser.class))
		...
		.insertOrUpdate(dao);
		dao.insertOrUpdate(new FieldFormat(idGroup,"023","23",NONE.getId(),null,null,"[0-9]+",3,null,"Application PAN sequence number",LTrimFixedFieldParser.class));
		...
		dao.insertOrUpdate(new FieldFormat(idGroup,"032","32",NONE.getId(),NONE.getId(),HEX.getId(),"[0-9]+",2,12,"Acquiring institution identification code",LTrimVarFieldParser.class));
		...
		dao.insertOrUpdate(new FieldFormat(idGroup,"070","70",NONE.getId(),null,null,"[0-9]+",4,null,"Network management information code",LTrimFixedFieldParser.class));
