...
import com.fimet.core.persistence.dao.PreferenceDAO;
...
public class PreferencesCreator implements ICreator {
	...
	public PreferencesCreator insertAll() {
		...
		dao.insertOrUpdate(new Preference(IPreferencesManager.CONSOLE_LEVEL, "" +(FimetLogger.INFO | FimetLogger.WARNING | FimetLogger.ERROR | FimetLogger.DEBUG)));
