...
import com.fimet.cfg.db.eg.fieldformat.Amex;
import com.fimet.cfg.db.eg.fieldformat.DiscoverPOS;
import com.fimet.cfg.db.eg.fieldformat.Jcb;
...
public class FieldFormatCreator implements ICreator {
	...
	public FieldFormatCreator createGroups() throws SQLException {
		TableUtils.createTableIfNotExists(connection, FieldFormatGroup.class);
		return this;
	}
	public FieldFormatCreator dropGroups() throws SQLException {
		TableUtils.dropTable(connection, FieldFormatGroup.class, true);
		return this;
	}
	...
	public FieldFormatCreator insertGroups() {
		...
		daoGroup.insertOrUpdate(new FieldFormatGroup(AMEX.getId(),AMEX.getName()));
		daoGroup.insertOrUpdate(new FieldFormatGroup(JCB.getId(),JCB.getName()));
		...
		daoGroup.insertOrUpdate(new FieldFormatGroup(EXTRACT_BASE_ATM.getId(),EXTRACT_BASE_ATM.getName()));
		return this;
	}
	...
	public FieldFormatCreator insertAmex() {
		new Amex(dao).insert();
		return this;
	}
	public FieldFormatCreator insertJcb() {
		new Jcb(dao).insert();
		return this;
	}
	...
	public FieldFormatCreator insertATMNacionalExtractBase() {
		new NacionalATMExtractBase(dao).insert();
		return this;
	}
