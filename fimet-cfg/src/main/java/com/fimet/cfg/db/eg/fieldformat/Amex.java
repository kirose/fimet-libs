...
public class Amex {
	FieldFormatDAO dao;
	int idGroup = FieldFormatGroup.AMEX.getId();
	public Amex(FieldFormatDAO dao) {
		this.dao = dao;
	}
	public void insert() {
		...
		dao.insertOrUpdate(new FieldFormat(idGroup,"012","12",NONE.getId(),null,null,"[0-9]+",12,null,"Local transaction time (hhmmss)",FixedFieldParser.class));
		...
		dao.insertOrUpdate(new FieldFormat(idGroup,"022","22",NONE.getId(),null,null,"[0-9A-Za-z]+",12,null,"Point of service entry mode",FixedFieldParser.class));
		...
		dao.insertOrUpdate(new FieldFormat(idGroup,"025","25",NONE.getId(),null,null,"[A-Z0-9]+",4,null,"Point of service condition code",FixedFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"026","26",NONE.getId(),null,null,"[0-9]+",4,null,"Point of service capture code",FixedFieldParser.class));
		...
		dao.insertOrUpdate(new FieldFormat(idGroup,"028","28",NONE.getId(),null,null,"[0-9]+",6,null,"Amount, transaction fee",FixedFieldParser.class));
		...
		dao.insertOrUpdate(new FieldFormat(idGroup,"031","31",NONE.getId(),null,null,"[0-9A-Za-z ]+",2,15,"Amount, settlement processing fee",VarFieldParser.class));
		...
		dao.insertOrUpdate(new FieldFormat(idGroup,"039","39",NONE.getId(),null,null,"[a-zA-Z0-9 ]+",3,null,"Response code",FixedFieldParser.class));
		...
		dao.insertOrUpdate(new FieldFormat(idGroup,"041","41",NONE.getId(),null,null,"(?s).+",8,null,"Card acceptor terminal identification",FixedFieldParser.class));
		...
		dao.insertOrUpdate(new FieldFormat(idGroup,"043","43",NONE.getId(),null,null,"(?s).+",2,99,"Card acceptor name/location",VarFieldParser.class));
		...
		dao.insertOrUpdate(new FieldFormat(idGroup,"055","55",ASCII_TO_HEX.getId(),NONE.getId(),DEC.getId(),"(?s).+",3,999,"ICC data EMV having multiple tags",VarFieldParser.class));
//		new FieldFormatBuilder(new FieldFormat(idGroup,"055","55",ASCII_TO_HEX.getId(),NONE.getId(),DEC.getId(),"(?s).+",3,999,"ICC data EMV having multiple tags",NatTagsVarFieldParser.class))
//			.add(new FieldFormat(idGroup,"001","5F2A",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).*",2,99,"Transaction Currency Code",NatTagVarFieldParser.class))
//			.add(new FieldFormat(idGroup,"002","71",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).*",2,99,"Issuer Script Template 1",NatTagVarFieldParser.class))
//			.add(new FieldFormat(idGroup,"003","72",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).*",2,99,"Issuer Script Template 2",NatTagVarFieldParser.class))
//			.add(new FieldFormat(idGroup,"004","82",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).*",2,99,"Application Interchange Profile",NatTagVarFieldParser.class))
//			.add(new FieldFormat(idGroup,"005","84",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).*",2,99,"Dedicated File Name",NatTagVarFieldParser.class))
//			.add(new FieldFormat(idGroup,"006","91",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).*",2,99,"Issuer Authentication Data (Provides data to be transmitted to the card for issuer authentication.)",NatTagVarFieldParser.class))
//			.add(new FieldFormat(idGroup,"007","95",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).*",2,99,"Terminal Verification Result (TVR)",NatTagVarFieldParser.class))
//			.add(new FieldFormat(idGroup,"008","9A",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).*",2,99,"Transaction Date",NatTagVarFieldParser.class))
//			.add(new FieldFormat(idGroup,"009","9C",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).*",2,99,"Transaction Type",NatTagVarFieldParser.class))
//			.add(new FieldFormat(idGroup,"010","9F02",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).*",2,99,"Amount Authorized",NatTagVarFieldParser.class))
//			.add(new FieldFormat(idGroup,"011","9F03",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).*",2,99,"Amount Other",NatTagVarFieldParser.class))
//			.add(new FieldFormat(idGroup,"012","9F09",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).*",2,99,"Application Version Number",NatTagVarFieldParser.class))
//			.add(new FieldFormat(idGroup,"013","9F10",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).*",2,99,"Issuer Application Data (IAD)",NatTagVarFieldParser.class))
//			.add(new FieldFormat(idGroup,"014","9F1A",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).*",2,99,"Terminal Country Code",NatTagVarFieldParser.class))
//			.add(new FieldFormat(idGroup,"015","9F1E",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).*",2,99,"Interface Device (IFD) Serial Number",NatTagVarFieldParser.class))
//			.add(new FieldFormat(idGroup,"016","9F26",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).*",2,99,"Application Cryptogram (AC)",NatTagVarFieldParser.class))
//			.add(new FieldFormat(idGroup,"017","9F27",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).*",2,99,"Cryptogram Information Data",NatTagVarFieldParser.class))
//			.add(new FieldFormat(idGroup,"018","9F33",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).*",2,99,"Terminal Capabilities",NatTagVarFieldParser.class))
//			.add(new FieldFormat(idGroup,"019","9F34",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).*",2,99,"Cardholder Verification Method (CVM) Results",NatTagVarFieldParser.class))
//			.add(new FieldFormat(idGroup,"020","9F35",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).*",2,99,"Terminal Type",NatTagVarFieldParser.class))
//			.add(new FieldFormat(idGroup,"021","9F36",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).*",2,99,"Application Transaction Counter",NatTagVarFieldParser.class))
//			.add(new FieldFormat(idGroup,"022","9F37",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).*",2,99,"Unpredictable Number",NatTagVarFieldParser.class))
//			.add(new FieldFormat(idGroup,"023","9F41",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).*",2,99,"Transaction Sequence Counter",NatTagVarFieldParser.class))
//			.add(new FieldFormat(idGroup,"024","9F53",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).*",2,99,"Transaction Category Code",NatTagVarFieldParser.class))
//			.add(new FieldFormat(idGroup,"025","9F5B",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).*",2,99,"Issuer Script Results",NatTagVarFieldParser.class))
//			.add(new FieldFormat(idGroup,"026","9F6E",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).*",2,99,"Form Factor Indicator",NatTagVarFieldParser.class))
//		.insertOrUpdate(dao);
		dao.insertOrUpdate(new FieldFormat(idGroup,"056","56",NONE.getId(),NONE.getId(),DEC.getId(),"(?s).+",2,999,"Reserved (ISO)",VarFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"057","57",NONE.getId(),NONE.getId(),DEC.getId(),"(?s).+",2,999,"Reserved (national)",VarFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"058","58",NONE.getId(),NONE.getId(),DEC.getId(),"(?s).+",2,999,"Reserved (national)",VarFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"059","59",NONE.getId(),NONE.getId(),DEC.getId(),"(?s).+",2,999,"Reserved (national)",VarFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"060","60",NONE.getId(),NONE.getId(),DEC.getId(),"(?s).*",2,999,"Reserved (national) (e.g. settlement request: batch number, advice transactions: original transaction amount, batch upload: original MTI plus original RRN plus original STAN, etc)",VarFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"061","61",NONE.getId(),NONE.getId(),DEC.getId(),"(?s).*",2,999,"Reserved (private) (e.g. CVV2/service code   transactions)",VarFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"062","62",NONE.getId(),NONE.getId(),DEC.getId(),"(?s).*",2,999,"Reserved (private) (e.g. transactions: invoice number, key exchange transactions: TPK key, etc.)",VarFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"063","63",NONE.getId(),NONE.getId(),DEC.getId(),"(?s).*",2,999,"Reserved (private)",VarFieldParser.class));
