...
import static com.fimet.commons.numericparser.NumericParser.HEX_HALF;
...
public class Visa {
	...
	public void insert() {
		...
		dao.insertOrUpdate(new FieldFormat(idGroup,"001","1",NONE.getId(),null,null,"[a-fA-F0-9]+",64,null,"Second Bitmap",LTrimFixedFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"002","2",NONE.getId(),NONE.getId(),HEX.getId(),".+",2,19,"Primary account number (PAN)",LTrimVarFieldParser.class));
		new FieldFormatBuilder(new FieldFormat(idGroup,"003","3",NONE.getId(),null,null,"[0-9]+",6,null,"Processing code",LTrimFixedFieldParser.class))
		...
		.insertOrUpdate(dao);
		dao.insertOrUpdate(new FieldFormat(idGroup,"004","4",NONE.getId(),null,null,"[0-9]+",12,null,"Amount, transaction",LTrimFixedFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"005","5",NONE.getId(),null,null,"[0-9]+",12,null,"Amount, settlement",LTrimFixedFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"006","6",NONE.getId(),null,null,"[0-9]+",12,null,"Amount, cardholder billing",LTrimFixedFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"007","7",NONE.getId(),null,null,"[0-9]+",10,null,"Transmission date & time",LTrimFixedFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"008","8",NONE.getId(),null,null,"[0-9]+",8,null,"Amount, cardholder billing fee",LTrimFixedFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"009","9",NONE.getId(),null,null,"[0-9]+",8,null,"Conversion rate, settlement",LTrimFixedFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"010","10",NONE.getId(),null,null,"[0-9]+",8,null,"Conversion rate, cardholder billing",LTrimFixedFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"011","11",NONE.getId(),null,null,"[0-9]+",6,null,"System trace audit number (STAN)",LTrimFixedFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"012","12",NONE.getId(),null,null,"[0-9]+",6,null,"Local transaction time (hhmmss)",LTrimFixedFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"013","13",NONE.getId(),null,null,"[0-9]+",4,null,"Local transaction date (MMDD)",LTrimFixedFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"014","14",NONE.getId(),null,null,"(?s).+",4,null,"Expiration date",LTrimFixedFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"015","15",NONE.getId(),null,null,"[0-9]+",4,null,"Settlement date",LTrimFixedFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"016","16",NONE.getId(),null,null,"[0-9]+",4,null,"Currency conversion date",LTrimFixedFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"017","17",NONE.getId(),null,null,"[0-9]+",4,null,"Capture date",LTrimFixedFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"018","18",NONE.getId(),null,null,"[0-9]+",4,null,"Merchant type, or merchant category code",LTrimFixedFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"019","19",NONE.getId(),null,null,"[0-9]+",3,null,"Acquiring institution (country code)",LTrimFixedFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"020","20",NONE.getId(),null,null,"[0-9]+",3,null,"PAN extended (country code)",LTrimFixedFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"021","21",NONE.getId(),null,null,"[0-9]+",3,null,"Forwarding institution (country code)",LTrimFixedFieldParser.class));
		new FieldFormatBuilder(new FieldFormat(idGroup,"022","22",NONE.getId(),null,null,"[0-9]+",3,null,"Point of service entry mode",RTrimFixedFieldParser.class))
		...
		.insertOrUpdate(dao);
		dao.insertOrUpdate(new FieldFormat(idGroup,"023","23",NONE.getId(),null,null,"[0-9]+",5,null,"Application PAN sequence number",LTrimFixedFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"024","24",NONE.getId(),null,null,"[0-9]+",3,null,"Function code (ISO 8583:1993), or network international identifier (NII)",LTrimFixedFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"025","25",NONE.getId(),null,null,"[A-Z0-9]+",2,null,"Point of service condition code",LTrimFixedFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"026","26",NONE.getId(),null,null,"[0-9]+",2,null,"Point of service capture code",LTrimFixedFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"027","27",NONE.getId(),null,null,"[0-9]+",1,null,"Authorizing identification response length",LTrimFixedFieldParser.class));
		...
		dao.insertOrUpdate(new FieldFormat(idGroup,"032","32",NONE.getId(),NONE.getId(),HEX.getId(),"[0-9]+",4,24,"Acquiring institution identification code",LTrimVarFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"033","33",NONE.getId(),NONE.getId(),HEX.getId(),"[0-9]+",2,12,"Forwarding institution identification code",LTrimVarFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"034","34",NONE.getId(),NONE.getId(),HEX.getId(),"[^a-zA-Z ]+",2,28,"Primary account number, extended",LTrimVarFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"035","35",NONE.getId(),NONE.getId(),HEX.getId(),"[0-9]{8,19}(=|D).+",2,37,"Track 2 data",LTrimVarFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"036","36",NONE.getId(),NONE.getId(),HEX.getId(),"[0-9]+",3,104,"Track 3 data",LTrimVarFieldParser.class));
		...
		dao.insertOrUpdate(new FieldFormat(idGroup,"040","40",NONE.getId(),null,null,"[a-zA-Z0-9 ]+",3,null,"Service restriction code",LTrimFixedFieldParser.class));
		...
		dao.insertOrUpdate(new FieldFormat(idGroup,"049","49",NONE.getId(),null,null,"[a-zA-Z0-9 ]+",3,null,"Currency code, transaction",LTrimFixedFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"050","50",NONE.getId(),null,null,"[a-zA-Z0-9 ]+",3,null,"Currency code, settlement",LTrimFixedFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"051","51",NONE.getId(),null,null,"[a-zA-Z0-9 ]+",3,null,"Currency code, cardholder billing",LTrimFixedFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"052","52",NONE.getId(),null,null,"[a-fA-F0-9]+",16,null,"Personal identification number data",LTrimFixedFieldParser.class));
		dao.insertOrUpdate(new FieldFormat(idGroup,"053","53",NONE.getId(),null,null,"[a-fA-F0-9]+",16,null,"Security related control information",LTrimFixedFieldParser.class));
		...
		dao.insertOrUpdate(new FieldFormat(idGroup,"060","60",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).*",4,12,"Reserved (national) (e.g. settlement request: batch number, advice transactions: original transaction amount, batch upload: original MTI plus original RRN plus original STAN, etc)",VarFieldParser.class));
		...
		new FieldFormatBuilder(new FieldFormat(idGroup,"062","62",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,510,"Reserved (private) (e.g. transactions: invoice number, key exchange transactions: TPK key, etc.)",Visa62VarFieldParser.class))
			...
			.add(new FieldFormat(idGroup,"002","2",NONE.getId(),null,null,"(?s).+",15,null,"Transaction Identifier",LTrimFixedFieldParser.class))
			...
			.add(new FieldFormat(idGroup,"005","5",NONE.getId(),null,null,"(?s).+",2,null,"Duration",LTrimFixedFieldParser.class))
			...
			.add(new FieldFormat(idGroup,"020","20",NONE.getId(),null,null,"(?s).+",10,null,"Merchant Verification Value",LTrimFixedFieldParser.class))
		...
		dao.insertOrUpdate(new FieldFormat(idGroup,"068","68",NONE.getId(),null,null,"[0-9]+",3,null,"Receiving institution country code",LTrimFixedFieldParser.class));
		...
		dao.insertOrUpdate(new FieldFormat(idGroup,"070","70",NONE.getId(),null,null,"[0-9]+",3,null,"Network management information code",LTrimFixedFieldParser.class));
		...
		dao.insertOrUpdate(new FieldFormat(idGroup,"073","73",NONE.getId(),null,null,"[0-9]+",6,null,"Action date (YYMMDD)",LTrimFixedFieldParser.class));
		...
		new FieldFormatBuilder(new FieldFormat(idGroup,"090","90",NONE.getId(),null,null,"[a-zA-Z0-9 ]+",42,null,"Original data elements",LTrimFixedFieldParser.class))
		...
		dao.insertOrUpdate(new FieldFormat(idGroup,"121","121",NONE.getId(),NONE.getId(),HEX_HALF.getId(),"(?s).+",6,510,"Reserved for private use",LTrimVarFieldParser.class));
		...
		new FieldFormatBuilder(new FieldFormat(idGroup,"123","123",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,510,"Reserved for private use",VisaDatasetsVarFieldParser.class))
			.add(new FieldFormatBuilder(new FieldFormat(idGroup,"001","66",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"[a-fA-F0-9]*",4,510,"Verification Data",VisaDatasetVarFieldParser.class))
				.add(new FieldFormat(idGroup,"001","C0",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,18,"Postal Code",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"002","CF",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,80,"Street Address",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"003","D0",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,28,"Compressed AVS Data",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"004","D4",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,52,"Cardholder Name",VisaTagVarFieldParser.class))
			)
			.add(new FieldFormatBuilder(new FieldFormat(idGroup,"002","67",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"[a-fA-F0-9]*",4,510,"Activation Verification Data",VisaDatasetVarFieldParser.class))
				.add(new FieldFormat(idGroup,"001","03",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,2,"Activation Verification Result",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"002","04",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,4,"Active Account Management Velocity Checking Result",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"003","05",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,8,"Cardholder Verification Methods Identified by Cardholder Device",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"004","07",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,4,"Issuer Special Condition Code",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"005","08",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,2,"Token Verification Result Code",VisaTagVarFieldParser.class))
			)
			.add(new FieldFormatBuilder(new FieldFormat(idGroup,"003","68",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"[a-fA-F0-9]*",4,510,"Token Data",VisaDatasetVarFieldParser.class))
				.add(new FieldFormat(idGroup,"001","1F31",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,8,"Elapsed Time To Live",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"002","1F32",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,6,"Count of Number of Transactions",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"003","1F33",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,14,"Cumulative Transaction Amount",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"004","1F35",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,4,"Total Number of Tokens for Token Inquiry Criteria",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"005","1F37",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,252,"Issuer Custom Data for File Control Information (FCI) Template",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"006","1F38",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,30,"Issuer Custom Data for Issuer Application Data (IAD)",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"007","01",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,38,"Token",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"008","02",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,4,"Token Assurance Level",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"009","03",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,22,"Token Requestor ID",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"010","04",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,38,"Primary Account Number, Account Range",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"011","05",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,64,"Token Reference ID",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"012","06",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,8,"Token Expiration Date",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"013","07",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,4,"Token Type",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"014","08",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,2,"Token Status",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"015","0A",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,2,"Last Updated By",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"016","0B",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,64,"PAN Reference ID",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"017","1A",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,16,"Activation Code",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"018","1B",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,24,"Activation Code Expiry Date/Time",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"019","1C",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,4,"Activation Code Verification Attempts",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"020","1D",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,4,"Number of Activation Codes Issued",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"021","10",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,4,"Visa Token Score",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"022","11",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,4,"Visa Token Decisioning",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"023","12",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,4,"Number of Active Tokens",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"024","13",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,4,"Number of Inactive Tokens",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"025","14",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,4,"Number of Suspended Tokens",VisaTagVarFieldParser.class))
			)
			.add(new FieldFormatBuilder(new FieldFormat(idGroup,"004","69",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"[a-fA-F0-9]*",4,510,"Account Lookup Results",VisaDatasetVarFieldParser.class))
				.add(new FieldFormat(idGroup,"001","05",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,6,"Card Issuer Country Code",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"002","06",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,2,"Fast Funds Indicator",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"003","07",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,2,"Blocked for all OCTs",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"004","08",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,2,"Online Gambling Block Indicator",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"005","09",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,2,"Geographic Restriction Indicator",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"006","0A",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,6,"Destination Currency Code",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"007","0B",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,2,"Destination Currency Code Minor Units",VisaTagVarFieldParser.class))
				.add(new FieldFormat(idGroup,"008","0C",NONE.getId(),NONE.getId(),HEX_DOUBLE.getId(),"(?s).+",2,6,"Issuing Institution Country Code",VisaTagVarFieldParser.class))
			)
		.insertOrUpdate(dao);
