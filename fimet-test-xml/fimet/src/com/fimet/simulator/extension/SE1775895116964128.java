...
**/
public class SE1775895116964128 extends AbstractSimulatorExtension {
	...
	**/
	...
	public IAssertionResult[] validateIncomingMessage(ISimulator simulator, IMessage msg){
		if ("Oxxo".equals(simulator.getName())){
			return new IAssertionResult[]{
				exe("DE39",msg,(m)->{return Equals("01",m.getValue(39));})
			};
		}
		return null;
	}
	...
	**/
	...
	public IMessage simulateOutgoingMessage(ISimulator simulator, IMessage msg){
		if ("OxxoIss".equals(simulator.getName())){
			msg.remove("17");
			msg.remove("13");
